...
KohonenSOMResultPtr KohonenSOM::map(const KohonenSOMDataPtr &data, const KohonenSOMSampleDataPtr &sampleData, uint maxNodes) {
    return KohonenSOMResultPtr(nullptr);
}
